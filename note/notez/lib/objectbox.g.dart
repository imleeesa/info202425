...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 2253025369240755164),
      name: 'Note',
      lastPropertyId: const IdUid(3, 5622986938894270055),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 767871061090782312),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 2138317384110428472),
            name: 'title',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 5622986938894270055),
            name: 'text',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 2253025369240755164),
...
class Note_ {
  ...
  /// see [Note.text]
  static final text = QueryStringProperty<Note>(_entities[0].properties[2]);
}
